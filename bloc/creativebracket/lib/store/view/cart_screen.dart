...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isCardEmpty = context.select<StoreBloc, bool>(
        (storeBloc) => storeBloc.state.cartIds.isEmpty);
    final cartProducts = context.select<StoreBloc, List<Product>>((storeBloc) =>
        storeBloc.state.products

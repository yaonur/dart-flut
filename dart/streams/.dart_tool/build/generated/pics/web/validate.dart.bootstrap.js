...
let modulePaths = {
 ...
 "web/validate": "validate.ddc"
};
if(!window.$dartLoader) {
   window.$dartLoader = {
     appDigests: _currentDirectory + 'validate.digests',
...
define("validate.dart.bootstrap", ["web/validate", "dart_sdk"], function(app, dart_sdk) {
  ...
  (app.web__validate || app.validate).main();
  var bootstrap = {
  ...
  dart_sdk.dart.trackLibraries("validate.dart.bootstrap", {
    "validate.dart.bootstrap": bootstrap
  }, '');
  return {
    bootstrap: bootstrap
  };

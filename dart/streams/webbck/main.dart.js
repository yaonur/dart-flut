...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    _ForwardingStreamSubscription$(_stream, onData, onError, onDone, cancelOnError, $S, $T) {
      var t4, t5,
        ...
        t3 = onData == null ? A.async___nullDataHandler$closure() : onData;
      type$.$env_1_1_void._bind$1($T)._eval$1("1(2)")._as(t3);
      ...
      t2 = new A._ForwardingStreamSubscription(_stream, t3, t4, type$.void_Function._as(t5), t1, t2, $S._eval$1("@<0>")._bind$1($T)._eval$1("_ForwardingStreamSubscription<1,2>"));
    ...
    main() {
      var t1 = document,
        button = type$.ButtonElement._as(t1.querySelector("button")),
        t2 = type$._ElementEventStreamImpl_MouseEvent,
        t3 = t2._eval$1("_TakeStream<1>");
      new A._WhereStream(t3._eval$1("bool(1)")._as(new A.main_closure(type$.InputElement._as(t1.querySelector("input")))), new A._TakeStream(4, new A._ElementEventStreamImpl(button, "click", false, t2), t3), t3._eval$1("_WhereStream<1>")).listen$2$onDone(new A.main_closure0(), new A.main_closure1());
    },
  ...
  A._ForwardingStreamSubscription.prototype = {
    _ForwardingStreamSubscription$5(_stream, onData, onError, onDone, cancelOnError, $S, $T) {
      var _this = this;
      _this.set$_subscription(_this._stream._source.listen$3$onDone$onError(_this.get$_handleData(), _this.get$_handleDone(), _this.get$_handleError()));
    },
    _add$1(data) {
  ...
  A._TakeStream.prototype = {
    _createSubscription$4(onData, onError, onDone, cancelOnError) {
      ...
      t2 = _this._count;
      if (t2 === 0) {
        _this._source.listen$1(null).cancel$0();
      ...
      t5 = onData == null ? A.async___nullDataHandler$closure() : onData;
      type$.$env_1_1_void._bind$1(t1)._eval$1("1(2)")._as(t5);
      ...
      t4 = new A._StateStreamSubscription(t2, _this, t5, t6, type$.void_Function._as(t7), t3, t4, type$.$env_1_1_int._bind$1(t1)._eval$1("_StateStreamSubscription<1,2>"));
  ...
  A.main_closure.prototype = {
    call$1($event) {
      ...
      return this.input.value === "cherry";
    },
    $signature: 15
  };
  A.main_closure0.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event);
      return A.print("You got it!");
    },
    $signature: 16
  };
  A.main_closure1.prototype = {
    call$0() {
      return A.print("Nope, bad guesses.");
    },
    $signature: 0
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.Closure, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._BufferingStreamSubscription, A._DelayedEvent, A._DelayedDone, A._PendingEvents, A._DoneStreamSubscription, A._Zone, A.StackOverflowError, A._Exception, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription]);
    ...
    _inheritMany(A._ForwardingStream, [A._WhereStream, A._TakeStream]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(~())", "Null(@)", "Null()", "~(Object,StackTrace)", "Future<Null>()", "@(@)", "@(@,String)", "@(String)", "Null(~())", "Null(Object,StackTrace)", "_Future<@>(@)", "~(Object?)", "~(@,StackTrace)", "~(Event)", "bool(MouseEvent)", "~(MouseEvent)", "~(@)"],
    interceptorsByTag: null,
    leafTags: null,
    arrayRti: Symbol("$ti")
  };
  A._Universe_addRules(init.typeUniverse, JSON.parse('{"PlainJavaScriptObject":"LegacyJavaScriptObject","UnknownJavaScriptObject":"LegacyJavaScriptObject","JavaScriptFunction":"LegacyJavaScriptObject","AbortPaymentEvent":"Event","ExtendableEvent":"Event","MathMLElement":"Element","AudioElement":"HtmlElement","MediaElement":"HtmlElement","PointerEvent":"MouseEvent","CompositionEvent":"UIEvent","HtmlDocument":"Node","Document":"Node","JSBool":{"bool":[],"TrustedGetRuntimeType":[]},"JSNull":{"Null":[],"TrustedGetRuntimeType":[]},"JSArray":{"Iterable":["1"]},"JSUnmodifiableArray":{"JSArray":["1"],"Iterable":["1"]},"JSNumber":{"num":[]},"JSInt":{"int":[],"num":[],"TrustedGetRuntimeType":[]},"JSNumNotInt":{"num":[],"TrustedGetRuntimeType":[]},"JSString":{"String":[],"TrustedGetRuntimeType":[]},"LateError":{"Error":[]},"NullError":{"TypeError":[],"Error":[]},"JsNoSuchMethodError":{"Error":[]},"UnknownJsTypeError":{"Error":[]},"_StackTrace":{"StackTrace":[]},"Closure":{"Function":[]},"Closure0Args":{"Function":[]},"Closure2Args":{"Function":[]},"TearOffClosure":{"Function":[]},"StaticClosure":{"Function":[]},"BoundClosure":{"Function":[]},"_CyclicInitializationError":{"Error":[]},"RuntimeError":{"Error":[]},"_AssertionError":{"Error":[]},"_Error":{"Error":[]},"_TypeError":{"TypeError":[],"Error":[]},"_Future":{"Future":["1"]},"AsyncError":{"Error":[]},"_BufferingStreamSubscription":{"StreamSubscription":["1"],"_EventSink":["1"],"_EventDispatch":["1"]},"_DelayedData":{"_DelayedEvent":["1"]},"_DelayedError":{"_DelayedEvent":["@"]},"_DelayedDone":{"_DelayedEvent":["@"]},"_DoneStreamSubscription":{"StreamSubscription":["1"]},"_ForwardingStream":{"Stream":["2"]},"_ForwardingStreamSubscription":{"_BufferingStreamSubscription":["2"],"StreamSubscription":["2"],"_EventSink":["2"],"_EventDispatch":["2"],"_BufferingStreamSubscription.T":"2","_ForwardingStreamSubscription.S":"1","_ForwardingStreamSubscription.T":"2"},"_WhereStream":{"_ForwardingStream":["1","1"],"Stream":["1"],"_ForwardingStream.T":"1","_ForwardingStream.S":"1"},"_TakeStream":{"_ForwardingStream":["1","1"],"Stream":["1"],"_ForwardingStream.T":"1","_ForwardingStream.S":"1"},"_StateStreamSubscription":{"_ForwardingStreamSubscription":["2","2"],"_BufferingStreamSubscription":["2"],"StreamSubscription":["2"],"_EventSink":["2"],"_EventDispatch":["2"],"_BufferingStreamSubscription.T":"2","_ForwardingStreamSubscription.S":"2","_ForwardingStreamSubscription.T":"2"},"_Zone":{"Zone":[]},"_RootZone":{"_Zone":[],"Zone":[]},"int":{"num":[]},"AssertionError":{"Error":[]},"TypeError":{"Error":[]},"ArgumentError":{"Error":[]},"RangeError":{"Error":[]},"IndexError":{"Error":[]},"UnsupportedError":{"Error":[]},"UnimplementedError":{"Error":[]},"StateError":{"Error":[]},"ConcurrentModificationError":{"Error":[]},"StackOverflowError":{"Error":[]},"_StringStackTrace":{"StackTrace":[]},"MouseEvent":{"Event":[]},"HtmlElement":{"Element":[],"EventTarget":[]},"AnchorElement":{"Element":[],"EventTarget":[]},"AreaElement":{"Element":[],"EventTarget":[]},"ButtonElement":{"Element":[],"EventTarget":[]},"Element":{"EventTarget":[]},"FormElement":{"Element":[],"EventTarget":[]},"InputElement":{"Element":[],"EventTarget":[]},"Node":{"EventTarget":[]},"SelectElement":{"Element":[],"EventTarget":[]},"UIEvent":{"Event":[]},"_EventStream":{"Stream":["1"]},"_ElementEventStreamImpl":{"_EventStream":["1"],"Stream":["1"]},"_EventStreamSubscription":{"StreamSubscription":["1"]}}'));
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"_DelayedEvent":1}'));
  var string$ = {
